...
| Day | Part 1 | Part 2 |
| :---: | :---: | :---:  |
| [Day 1](./src/bin/01.rs) | `62.1µs` | `66.5µs` |
| [Day 2](./src/bin/02.rs) | `94.0ms` | `124.0ms` |
| [Day 3](./src/bin/03.rs) | `307.5µs` | `459.1µs` |
| [Day 4](./src/bin/04.rs) | `949.5µs` | `17.4ms` |
| [Day 5](./src/bin/05.rs) | `120.9µs` | `10.0µs` |
| [Day 6](./src/bin/06.rs) | `147.2µs` | `2.5ms` |
| [Day 7](./src/bin/07.rs) | `78.0µs` | `76.6µs` |
| [Day 8](./src/bin/08.rs) | `42.4ms` | `46.2ms` |
